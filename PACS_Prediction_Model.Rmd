...
library("biostatUZH")                 #version 1.8.-1
# install.packages("remotes")
# remotes::install_github("BavoDC/CalibrationCurves")
library("CalibrationCurves")          #version 0.1.2
library("ggplot2")                    #version 3.3.5
library("ggpubr")                     #version 0.4.0
library("tidyverse")                  #version 1.3.1
library("readxl")                     #version 1.3.1
library("rstudioapi")                 #version 0.13
library("epitools")                   #version 0.5-10.1
library("pROC")                       #version 1.18.0
library("gbm")                        #version 2.1.8
library("shrink")                     #version 1.2.1
library("ggstatsplot")                #version 0.9.0
...
xdata <-
  read_excel("/Users/peterjemley/Downloads/41467_2021_27797_MOESM5_ESM.xlsx",
             na = "NA")
