...
Packages are listed alphabetically to check versions with packageVersion(). 
```{r}
...
## 2.b.4 Primary infection & 6-month follow-up
```{r}
...
## 2.b.5 Without Healthy controls
```{r}
...
## 2.b.7 Patients with history of asthma
```{r}
...
## 2.b.10 Complete observations: Patients with blood sampling at all three patient visits
```{r}
